...
public class SecurityConfig {
    ...
    private static final String TRAINEE_PATH_WILDCARD = "/trainee/**";
    private static final String ADMIN_PATH_WILDCARD = "/admin/**";
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(TRAINEE_PATH_WILDCARD).permitAll()
                        .requestMatchers(ADMIN_PATH_WILDCARD).permitAll()
